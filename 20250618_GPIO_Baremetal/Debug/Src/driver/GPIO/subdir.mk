...
Src/driver/GPIO/%.o Src/driver/GPIO/%.su Src/driver/GPIO/%.cyclo: ../Src/driver/GPIO/%.c Src/driver/GPIO/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DDEBUG -DSTM32 -DSTM32F4 -DSTM32F411RETx -c -I../Inc -I"C:/harman/STM32Cube/20250618_GPIO_Baremetal/Src/LedBar" -I"C:/harman/STM32Cube/20250618_GPIO_Baremetal/Src/driver" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"
